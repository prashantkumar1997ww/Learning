...
public class Color extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("Brown", "marron", R.drawable.color_brown, R.raw.marron));
        words.add(new Word("Gray", "dris", R.drawable.color_gray, R.raw.gray));
        ...
        WordAddapter adapter = new WordAddapter(this, words, R.color.category_color);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(Color.this, word.getmAudioResourceId());
